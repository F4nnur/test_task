...
export const setPostsSuccess = (data, x_total_count) => ({
    type: PostsActionsTypes.FETCH_POSTS_DATA_SUCCESS,
    payload: {data, x_total_count}
});
...
export const asyncSetPosts = (limit, page) => ({
    type: PostsActionsTypes.ASYNC_FETCH_POSTS_DATA_SUCCESS,
    payload: {limit, page}
})
...
export const searchPosts = (value, posts) => ({type: PostsActionsTypes.SEARCH_POSTS, payload: {value, posts}})
export const asyncSearchPosts = (value, posts) => ({
    type: PostsActionsTypes.SEARCH_POSTS_SUCCESS,
    payload: {value, posts}
})